...
var FACTORY_ADDRESS = '0xAa59fC24DC5876c598484932fAe4F372648bF737';
var INIT_CODE_HASH = '0x938b1bdfeb45a5965d0c93f8721787ef7b2c201e07e64a6d9b5c5f5afc6e020e';
...
Currency.CGLD_CURRENCY = /*#__PURE__*/new Currency(18, 'CGLD', 'Celo');
var CGLD_CURRENCY = Currency.CGLD_CURRENCY;
...
var CGLD = (_CGLD = {}, _CGLD[ChainId.MAINNET] = /*#__PURE__*/new Token(ChainId.MAINNET, '0x471ece3750da237f93b8e339c536989b8978a438', 18, 'CELO', 'Celo'), _CGLD[ChainId.ALFAJORES] = /*#__PURE__*/new Token(ChainId.ALFAJORES, '0xf194afdf50b03e69bd7d057c1aa9e10c9954e4c9', 18, 'CELO', 'Celo'), _CGLD);
var cUSD = (_cUSD = {}, _cUSD[ChainId.MAINNET] = /*#__PURE__*/new Token(ChainId.MAINNET, '0x765de816845861e75a25fca122bb6898b8b1282a', 18, 'CELO', 'Celo'), _cUSD[ChainId.ALFAJORES] = /*#__PURE__*/new Token(ChainId.ALFAJORES, '0x874069fa1eb16d44d622f2e0ca25eea172369bc1', 18, 'CELO', 'Celo'), _cUSD);
...
var CurrencyAmount = /*#__PURE__*/function (_Fraction) {
  ...
  CurrencyAmount.cgld = function cgld(amount) {
...
var Price = /*#__PURE__*/function (_Fraction) {
  ...
  _proto.quote = function quote(currencyAmount) {
    ...
    return CurrencyAmount.cgld(_Fraction.prototype.multiply.call(this, currencyAmount.raw).quotient);
  };
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === CGLD_CURRENCY && pairs[0].involvesToken(CGLD[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === CGLD_CURRENCY && pairs[pairs.length - 1].involvesToken(CGLD[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
    var path = [input instanceof Token ? input : CGLD[pairs[0].chainId]];
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === TradeType.EXACT_INPUT ? amount : route.input === CGLD_CURRENCY ? CurrencyAmount.cgld(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === TradeType.EXACT_OUTPUT ? amount : route.output === CGLD_CURRENCY ? CurrencyAmount.cgld(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance) {
    ...
    if (this.tradeType === TradeType.EXACT_OUTPUT) {
      ...
      return this.outputAmount instanceof TokenAmount ? new TokenAmount(this.outputAmount.token, slippageAdjustedAmountOut) : CurrencyAmount.cgld(slippageAdjustedAmountOut);
    }
  }
  /**
  ...
  _proto.maximumAmountIn = function maximumAmountIn(slippageTolerance) {
    ...
    if (this.tradeType === TradeType.EXACT_INPUT) {
      ...
      return this.inputAmount instanceof TokenAmount ? new TokenAmount(this.inputAmount.token, slippageAdjustedAmountIn) : CurrencyAmount.cgld(slippageAdjustedAmountIn);
    }
  }
  /**
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var cgldIn = trade.inputAmount.currency === CGLD_CURRENCY;
    var cgldOut = trade.outputAmount.currency === CGLD_CURRENCY; // the router does not support both cgld in and out

    !!(cgldIn && cgldOut) ? process.env.NODE_ENV !== "production" ? invariant(false, 'CGLD_CURRENCY_IN_OUT') : invariant(false) : void 0;
...
export { CGLD, CGLD_CURRENCY, ChainId, Currency, CurrencyAmount, FACTORY_ADDRESS, Fetcher, Fraction, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, Pair, Percent, Price, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, cUSD, currencyEquals, inputOutputComparator, tradeComparator };
