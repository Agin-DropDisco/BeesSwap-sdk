...
var CGLD = (_CGLD = {}, _CGLD[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0x471ece3750da237f93b8e339c536989b8978a438', 18, 'CELO', 'Celo'), _CGLD[exports.ChainId.ALFAJORES] = /*#__PURE__*/new Token(exports.ChainId.ALFAJORES, '0xf194afdf50b03e69bd7d057c1aa9e10c9954e4c9', 18, 'CELO', 'Celo'), _CGLD);
var cUSD = (_cUSD = {}, _cUSD[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0x765de816845861e75a25fca122bb6898b8b1282a', 18, 'CELO', 'Celo'), _cUSD[exports.ChainId.ALFAJORES] = /*#__PURE__*/new Token(exports.ChainId.ALFAJORES, '0x874069fa1eb16d44d622f2e0ca25eea172369bc1', 18, 'CELO', 'Celo'), _cUSD);
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === CGLD_CURRENCY && pairs[0].involvesToken(CGLD[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === CGLD_CURRENCY && pairs[pairs.length - 1].involvesToken(CGLD[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === CGLD_CURRENCY ? CurrencyAmount.cgld(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === CGLD_CURRENCY ? CurrencyAmount.cgld(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    !!(cgldIn && cgldOut) ?  invariant(false, 'CGLD_CURRENCY_IN_OUT')  : void 0;
...
exports.JSBI = JSBI;
exports.CGLD = CGLD;
exports.CGLD_CURRENCY = CGLD_CURRENCY;
